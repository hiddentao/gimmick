...
var debug = require('debug')('gimmick'),
  fs = require('fs'),
...
Trace.prototype.instrument = function(filePath) {
  ...
  var ast = esprima.parse(inputCode, { loc: true });
...
Trace.prototype.getDefinitions = function() {
  return this._instrumenter.getDefinitions();
};
